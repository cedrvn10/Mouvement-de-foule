...
list_id_canvas_set_of_points = init_set_points_epidemia_grid(set_of_points, grille_epidemie)

move_set_of_points(fenetre, set_of_points, list_id_canvas_set_of_points, grille_epidemie)
