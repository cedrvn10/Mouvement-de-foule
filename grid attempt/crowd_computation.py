...
from crowd_init import array_point_location_available, create_empty_set_of_points, \
...
def move_all_points_once(list_list_list_array_set_of_points, get_list_list_vector_direction=False):
    ...
    for list_list_array_locations in list_list_list_array_set_of_points:
        for list_array_coordinates_individual in list_list_array_locations:
            for array_coordinates_individual in list_array_coordinates_individual:
                array_moved_point = array_valid_new_point_coordinates(list_list_list_array_set_of_points,
                                                                      array_coordinates_individual)
                ...
                if get_list_list_vector_direction:
                    new_list_list_array_set_of_points[tuple_moved_points_coordinates[0]] \
                        [tuple_moved_points_coordinates[1]].append(array_moved_point - array_coordinates_individual)

                new_list_list_array_set_of_points[tuple_moved_points_coordinates[0]] \
                    [tuple_moved_points_coordinates[1]].append(array_moved_point)
