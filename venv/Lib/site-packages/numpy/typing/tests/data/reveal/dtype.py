...
reveal_type(
    np.dtype(np.int64)
)  # E: numpy.dtype[numpy.signedinteger[numpy.typing._64Bit]]
...
reveal_type(
    np.dtype("int32")
)  # E: numpy.dtype[numpy.signedinteger[numpy.typing._32Bit]]
...
reveal_type(
    np.dtype(complex)
)  # E: numpy.dtype[numpy.complexfloating[numpy.typing._64Bit, numpy.typing._64Bit]]
...
# Dtypes of dtypes
reveal_type(
    np.dtype(np.dtype(np.float64))
)  # E: numpy.dtype[numpy.floating[numpy.typing._64Bit]]
