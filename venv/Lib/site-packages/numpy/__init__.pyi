...
class flatiter(Generic[_ArraySelf]):
    ...
    def __getitem__(
        self,
        key: Union[_ArrayLikeInt, slice, ellipsis],
    ) -> _ArraySelf: ...
...
class _ArrayOrScalarCommon:
    ...
    @overload
    def reshape(self, __shape: Sequence[int], *, order: _OrderACF = ...) -> ndarray: ...
    @overload
    def reshape(self, *shape: int, order: _OrderACF = ...) -> ndarray: ...
...
class datetime64(generic):
    ...
    @overload
    def __init__(
        self, __value: int, __format: Union[_CharLike, Tuple[_CharLike, _IntLike]]
    ) -> None: ...
