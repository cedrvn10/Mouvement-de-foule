...
rout_rules = [
    ...
    {  # Subroutine
        ...
        "routine_def": {
            ...
            ): '\t{"#name#",-1,{{-1}},0,NULL,(f2py_init_func)#apiname#,doc_#apiname#},',
        },
        "need": {
            l_and(
                l_not(l_or(ismoduleroutine, isintent_c)), l_not(isdummyroutine)
...
\t\t\t\t/*(*f2py_func)(#callfortran#);*/"""
    ...
    {  # Wrapped function
        ...
        "routine_def": {
            l_not(
                l_or(ismoduleroutine, isdummyroutine)
            ): '\t{"#name#",-1,{{-1}},0,(char *)#F_WRAPPEDFUNC#(#name_lower#,#NAME#),(f2py_init_func)#apiname#,doc_#apiname#},',
